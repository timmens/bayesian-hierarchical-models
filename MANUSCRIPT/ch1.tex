...
We note that this does not define proper proability distribution, which will not matter in this case but can lead to problems in others \textcolor{red}{(Will I find a nice paper which describes this?)}.
...
\begin{remark}
  ...
  The interested reader is refered to \citet{meynandtweedie09}.
...
\end{theorem}
\begin{proof}
  See \citet{cogburn1972} for 1 and \citet{roberts1997} for 2.
\end{proof}
...
We conclude our digression on Bayesian thinking by presenting \emph{Hamiltonian Monte Carlo} (HMC), a innovative Markov chain Monte Carlo method from the statistical physics literature which works in higher dimensions  \citet{duane87}.
