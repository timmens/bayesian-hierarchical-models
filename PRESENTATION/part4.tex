...
\begin{frame}{Comparison}
	\Large{
		...
		\begin{itemize}
			\item[] \emphcol{Advantage:} accounts for all uncertainty in the parameter estimates when predicting the varying slopes/intercepts and their associated uncertainty
