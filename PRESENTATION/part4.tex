...
\begin{frame}{ML and Bayesian Approach: Results}
	\Large{
			...
			\begin{column}{0.48\textwidth}
				\begin{itemize}
					\item point estimates almost the same
					\item Bayes standard deviations for random effects may be higher because ML does not take into account group level variance
				\end{itemize}			
			\end{column}
